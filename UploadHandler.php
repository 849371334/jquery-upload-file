...
class UploadHandler
{
    ...
    public function __construct($options = null, $initialize = true, $error_messages = null) {
        ...
        $this->options = array(
            ...
            'upload_dir' => dirname($this->get_server_var('SCRIPT_FILENAME')).'/img/'.date("Ym").'/'.date("d").'/',
   	    'upload_url' => $this->get_full_url().'/img/'.date("Ym").'/'.date("d").'/',
    ...
    public function handle_file_upload($uploaded_file, $name, $size, $type, $error,
        ...
        $file = new \stdClass();
        $file->name = iconv("gb2312","UTF-8",$this->get_file_name($uploaded_file, $name, $size, $type, $error,
            $index, $content_range));
